...
def classify_with_model(model_path, input_folder, output_folder, image_size=(83, 61), confidence_threshold=0.9):
    """
...
if __name__ == "__main__":
    # Paths
    model_path = "alpha_recognition_model.keras"  # Path to your trained model
    input_folder = "output_characters_alpha"  # Folder with leftover images
    output_folder = "classified_images_alpha"  # Folder to store classified images
